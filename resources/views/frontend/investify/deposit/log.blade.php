...
@section('content')
    <div class="container-fluid default-page">
        <div class="row gy-30">
            <div class="col-xl-12">
                <div class="rock-add-money-log-area">
                    <div class="rock-dashboard-card">
                            ...
                            <form action="{{ route('user.deposit.log') }}" method="GET">
                                <div class="common-table-form-grid">
                                    <div class="input-field">
                                        <input type="text" class="box-input" value="{{ request('query') }}" name="query" placeholder="Procurar">
                        ...
                        {{ $deposits->onEachSide(1)->links('frontend::include.__pagination') }}
                    </div>
                </div>
            </div>
        </div>
