                        ...
                        <form action="{{ route('user.transactions') }}">
                            <div class="common-table-form-grid">
                                <div class="input-field">
                                    <input type="text" class="box-input" name="query" value="{{ request('query') }}" placeholder="{{ __('Search') }}">
                                ...
                                <div class="site-table-list">
                                    ...
                                    <div class="site-table-col">
                                        <span class="{{ txn_type($transaction->type->value,['success-text','danger-text'],'hardrock') }}">
                                         {{ txn_type($transaction->type->value,['+','-'],'hardrock') }} {{ setting('currency_symbol','global'). showamount($transaction->amount) }}
