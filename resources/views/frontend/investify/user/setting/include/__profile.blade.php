                ...
                <form action="{{ route('user.setting.profile-update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="rock-profile-settings-wrapper">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="rock-upload-input">
                                ...
                                <div class="upload-custom-file without-image">
                                    ...
                                    <label for="avatar" class="file-ok" style="background-image: url('{{ asset('assets/'.$user->avatar) }}')">
                        ...
                        <div class="row gy-24 gx-20">
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                                <div class="rock-single-input">
                                    ...
                                    <div class="input-field disabled">
                                        <input type="text" class="box-input" readonly disabled
                                            value="{{ $user->username }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                                <div class="rock-single-input">
                                    <label class="input-label">{{ __('CPF') }}</label>
                                    <div class="input-field disabled">
                                        <input type="tel" id="cpf" class="box-input" readonly disabled
                                            value="{{ $user->cpf }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                                <div class="rock-single-input">
                                    ...
                                    <div class="input-field disabled">
                                        <input type="email" id="email" class="box-input" disabled
                                            value="{{ $user->email }}">
                                    </div>
                                </div>
                            </div>
