...
<div class="container-fluid default-page">
    <div class="row gy-30">
        <div class="col-xl-12">
            @if($user->kyc == \App\Enums\KYCStatus::Pending->value || $user->kyc == \App\Enums\KYCStatus::Verified->value)
            <div class="rock-dashboard-card">
                <div class="rock-add-mony-modal">
                    <div class="rock-add-mony-content">
                        <div class="thumb">
                            <img src="{{ asset('assets/frontend/theme_base/hardrock/images/icons/checkbox.svg') }}" alt="information-circle">
                        </div>
                        <h4 class="title">
                    ...
                    <div class="rock-support-tickets-form">
                        <form action="{{ route('user.kyc.submit') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="rock-single-input">
                                <label class="input-label" for="">{{ __('Verification Type') }}</label>
