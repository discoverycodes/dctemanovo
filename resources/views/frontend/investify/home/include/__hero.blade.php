            ...
            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-4">
                <div class="banner-thumb-wrapper">
                    <div class="banner-thumb">
                        <img src="{{ asset('assets/frontend/theme_base/hardrock/images/banner/banner-four/banner-thumb.png') }}" alt="banner thumb">
                    </div>
                    <div class="banner-cercle">
                        <img src="{{ asset('assets/frontend/theme_base/hardrock/images/banner/banner-four/round-cercle.png') }}" alt="">
                    </div>
                </div>
            </div>
            <div class="banner-dot">
                <img src="{{ asset('assets/frontend/theme_base/hardrock/images/banner/banner-four/banner-dot.png') }}" alt="banner-dot">
            </div>
        </div>
    </div>
    <div class="banner-four-shapes">
        <div class="shape-one">
            <img src="{{ asset('assets/frontend/theme_base/hardrock/images/banner/banner-four/shape-01.png') }}" alt="banner-shape">
        </div>
        <div class="shape-two">
            <img src="{{ asset('assets/frontend/theme_base/hardrock/images/banner/banner-four/shape-02.png') }}" alt="banner-shape">
        </div>
        <span class="round-one">
            <img src="{{ asset('assets/frontend/theme_base/hardrock/images/banner/banner-four/banner-glow.png') }}" alt="banner-glow">
        </span>
    </div>
</section>
