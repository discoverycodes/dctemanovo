...
<section class="rock-how-it-works-section section-space-top include-bg"
    data-background="{{ asset('assets/frontend/theme_base/hardrock/images/bg/price-pattren.png') }}" id="howitworks">
    <div class="container">
                ...
                <div class="col-xxl-12">
                    <div class="rock-how-it-works-grid">
                        ...
                        <div class="rock-how-it-works-item">
                            <div class="icon">
                                <span>
                                    <img src="{{ asset('assets/'.$content->icon) }}" alt="works icon">
                                </span>
                            </div>
                            <div class="content">
