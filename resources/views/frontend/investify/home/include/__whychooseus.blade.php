...
<section class="rock-why-choose-section section-space-top include-bg"
    data-background="{{ asset('assets/frontend/theme_base/hardrock/images/bg/price-pattren.png') }}">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xxl-8 ciol-xl-6 col-lg-6">
                <div class="section-title-wrapper-four text-center section-title-space">
                    ...
                    <h2 class="section-title-four">{{ $data['title_big'] }}
                    </h2>
                </div>
            </div>
                ...
                <div class="rock-why-choose-item">
                    <div class="icon theme-bg-dark">
                        <span>
                            ...
                            <img src="{{ asset('assets/'.$content->icon) }}">
                            @else
                            {{$content->icon}}
                            @endif
                        </span>
