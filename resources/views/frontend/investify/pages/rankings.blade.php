           ...
           <div class="row justify-content-center">
              <div class="col-xxl-6 col-xl-6 col-lg-8">
                 ...
                 <span class="subtitle-four">{{ $data['title_small'] }}</span>
                    ...
                    <span class="mt-3" style="text-align: left;">{!! $data['content'] !!}</span> 
                 </div>
              </div>
           </div>
           <div class="row gy-30">
                @foreach($rankings as $ranking)
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="rock-ranking-badge-item" data-background="{{ asset('assets/frontend/theme_base/hardrock/images/bg/ranking-badge.png') }}">
                            <div class="inner">
                            <div class="icon">
                                <div class="thumb">
                                    <img src="{{ asset('assets/'.$ranking->icon) }}" alt="ranking-badge">
                                </div>
                                <div class="content">
