                ...
                <div class="rock-edit-withdraw-account-area">
                    <div class="rock-dashboard-card">
                        ...
                        <div class="rock-edit-withdraw-account-form">
                            <form action="{{ route('user.withdraw.account.update',$withdrawAccount->tnx) }}" method="POST" enctype="multipart/form-data">
                                @method('POST')
                                @csrf
                                <input type="hidden" name="withdraw_method_id" value="{{$withdrawAccount->withdraw_method_tnx}}">
                                <div class="row gy-50">
                                            ...
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 selectMethodCol">
                                                <div class="rock-single-input">
                                                    ...
                                                    <div class="input-field">
                                                        <input type="text" class="box-input" placeholder="eg. Withdraw Method - USD" value="{{ $withdrawAccount->method_name }}" readonly disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            @php
                                                ...
                                                $method = WithdrawMethod::where('tnx', $withdrawAccount->withdraw_method_tnx)->first();
                                            ...
                                            @foreach($credentials as $key => $field)
                                                ...
                                                @if($field['type'] == 'file')
                                                    ...
                                                    <div class="col-xl-6 col-md-12">
                                                     ...
                                                     @elseif($fieldType === 'select' && $originalField && isset($originalField['options']))
                                                      ...
                                                      <div class="col-xl-6 col-md-12 selectMethodCol">
                                                            <div class="rock-single-input">
                                                                <label class="input-label">{{ $fieldName }}</label>
                                                                <div class="input-select">
                                                                    <select class="site-nice-select" id="selectType" name="credentials[{{ $fieldName }}][value]"
                                                                         @if($fieldValidation === 'required') readonly disabled @endif>
