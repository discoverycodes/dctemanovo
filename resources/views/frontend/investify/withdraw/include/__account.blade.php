...
@foreach( json_decode($withdrawMethod->fields, true) as $key => $field)
        ...
        <div class="col-xl-6 col-md-12">
            ...
            <div class="rock-upload-input">
                ...
                <div class="upload-custom-file without-image">
                    <input type="file" id="image{{ $key }}" name="credentials[{{ $field['name'] }}][value]" accept=".gif, .jpg, .png"                 @if($field['validation'] == 'required') required @endif
        ...
        <div class="col-xl-6 col-md-12">
            <div class="rock-single-input">
                ...
                <div class="input-field">
                    <textarea name="credentials[{{$field['name']}}][value]"  @if($field['validation'] == 'required') required @endif></textarea>
                </div>
            </div>
        </div>
    {{-- Campo tipo select --}}
    ...
    <div class="col-xl-6 col-md-12 selectMethodCol">
        <div class="rock-single-input">
            <label class="input-label">{{ ucwords(str_replace('_',' ',$field['name'])) }}</label>
    ...
    @else
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6">
            <div class="rock-single-input">
                <label class="input-label" for="">{{ ucwords( str_replace('_',' ',$field['name']) ) }}</label>
                <div class="input-field">
                    <input type="text" class="box-input" name="credentials[{{ $field['name']}}][value]" @if($field['validation'] == 'required') required @endif>
                </div>
            </div>
        </div>
    @endif
