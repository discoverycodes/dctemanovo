                                            ...
                                            <td>
                                                <div class="table-description">
                                                    ...
                                                    <div class="description">
                                                        ...
                                                        @endif
                                                        <div class="date">{{ formatar_data_brasileira($raw->created_at) }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><strong>{{ $raw->tnx }} </strong></td>

                                            <td>  @if($raw->status->value == 'estornado')
                                                <strong class="green-color">+{{ setting('currency_symbol','global') }}{{showamount($raw->amount) }}</strong>
                                                @else
                                                <strong class="red-color">-{{ setting('currency_symbol','global') }}{{showamount($raw->amount) }}</strong>
                                                @endif
                                            </td>
                                            <td>@if($raw->status->value == 'estornado')
                                                <strong class="green-color">+{{ setting('currency_symbol','global') }}{{ showamount($raw->charge) }}</strong>
                                                 @else
                                               <strong class="red-color">-{{ setting('currency_symbol','global') }}{{ showamount($raw->charge) }}</strong>
                                                @endif
                                            </td>
                                            <td>
                        ...
                        @foreach($withdraws as $raw )
                            <div class="single-transaction">
                                ...
                                <div class="transaction-right">
                                    ...
                                    @elseif($raw->status->value ==  App\Enums\TxnStatus::Estornado->value)
