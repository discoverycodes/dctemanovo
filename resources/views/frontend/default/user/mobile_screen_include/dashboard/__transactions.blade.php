            ...
            <div class="single-transaction">
                ...
                <div class="transaction-right">
                    <div class="transaction-amount {{ txn_type($transaction->type->value,['add','sub']) }}">
                        {{txn_type($transaction->type->value,['+','-']).$currencySymbol.showAmount($transaction->amount) }}</div>
                    <div class="transaction-fee sub">{{__('Fee')}} -{{  $currencySymbol.showAmount($transaction->charge) }} </div>
