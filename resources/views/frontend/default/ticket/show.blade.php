            ...
            <div class="site-card overflow-hidden">
                ...
                <div class="site-card-body">
                    <div class="support-ticket-single-message user">
                        <div class="logo">
                            <img class="avatar" src="{{ asset('assets/'.$ticket->user->avatar ?? 'assets/global/materials/user.png')}}"
                        ...
                        <div class="message-attachments">
                            ...
                            <div class="single-attachment">
                                ...
                                <div class="attach">
                                    <a href="{{ asset('assets/'.$ticket->attach) }}" target="_blank"><i
                        ...
                        <div
                            ...
                            <div class="logo">
                                ...
                                @if( $message->model != 'admin')
                                    <img class="avatar  avatar-round"
                                         src="{{ asset('assets/'.$ticket->user->avatar ?? 'assets/global/materials/user.png' )}}" alt=""
                                         height="40" width="40">
                                @else
                                    <img class="avatar  avatar-round"
                                         src="{{ asset('assets/'.$message->user->avatar ?? 'assets/global/materials/user.png' )}}" alt=""
                                         height="40" width="40">
                                @endif
                            </div>
                            <div class="message-body">
                            ...
                            @if($message->attach)
                                <div class="message-attachments">
                                    ...
                                    <div class="single-attachment">
                                        <div class="attach">
                                            <a href="{{ asset('assets/'.$message->attach) }}" target="_blank"><i
